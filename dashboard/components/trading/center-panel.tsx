...
import { ChartSyncController } from '@/components/charts/chart-sync-controller'
...
export function CenterPanel({
  ...
  const chartSync = useMemo(() => new ChartSyncController(), [pair.instrumentId, timeframe])
